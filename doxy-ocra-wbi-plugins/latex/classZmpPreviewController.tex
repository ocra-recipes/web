...
\item[\hyperlink{todo__todo000012}{\-Todo}]\-Check the first for loop of this method. \-I think this should be \-Np -\/ 1 \end{DoxyRefDesc}
...
\end{DoxySeeAlso}
\begin{DoxyRefDesc}{\-Todo}
\item[\hyperlink{todo__todo000011}{\-Todo}]\-Remember that the b\-Optimal \-I have to use is actually not \-Weiber's because it doesn't take into account com velocity references.\end{DoxyRefDesc}
