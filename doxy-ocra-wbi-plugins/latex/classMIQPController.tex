...
\mbox{[}\{array\}\{cccc\} \{\-C\}\-\_\-i\{\-T\} \& 0 \&  \& 0 $\backslash$ \{\-C\}\-\_\-i\{\-Q\}\{\-T\} \& \{\-C\}\-\_\-i\{\-T\} \&  \& 0 $\backslash$  \&  \&  \&  $\backslash$ \{\-C\}\-\_\-i\{\-Q\}$^\wedge$\{\-N-\/1\}\{\-T\} \& \{\-C\}\-\_\-i\{\-Q\}$^\wedge$\{\-N-\/2\}\{\-T\} \&  \& \{\-C\}\-\_\-i\{\-T\} \{array\}\mbox{]} = \mbox{[}\{array\}\{c\} \{f\}\-\_\-c$\backslash$ \{f\}\-\_\-c$\backslash$ $\backslash$ \{f\}\-\_\-c \{array\}\mbox{]} -\/ \mbox{[}\{array\}\{c\} \{\-C\}\-\_\-i\{\-Q\}$\backslash$ \{\-C\}\-\_\-i\{\-Q\}$^\wedge$2$\backslash$ $\backslash$ \{\-C\}\-\_\-i\{\-Q\}$^\wedge$\-N \{array\}\mbox{]} \{\}\-\_\-k
...
\-Matrix \-A of the equality constraints of the \hyperlink{namespaceMIQP}{\-M\-I\-Q\-P} problem, i.\-e. \[ \mathbf{A}_{\text{eq}} \mathcal{\mathbf{X}} = \mathbf{b}_{\text{eq}} \]
