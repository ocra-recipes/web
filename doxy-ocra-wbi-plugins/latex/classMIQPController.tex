...
\-Builds the equality constraints matrices \hyperlink{classMIQPController_abc22f1db5a2dbcab4006c1b903a19c4e}{\-\_\-\-Aeq}, \hyperlink{classMIQPController_a59bee510bcc945ad2267a82ec2116d79}{\-\_\-\-Beq}. \-For the time being, the equality constraints are composed of only the so-\/called \-Simultaneity constraints of the problem, which guarantee that allowing a discontinuity of one of the bounds ( $\matbf{a},\mathbf{b}$) in one direction simultaneously allows a discontinuity in the orthogonal direction. \-This requirement writes\-:
...
\item[\hyperlink{todo__todo000008}{\-Todo}]\-Watch out! \-\_\-eig\-Gurobi will add a 1/2. \-Therefore the 2. \-Check that this is correct. 
