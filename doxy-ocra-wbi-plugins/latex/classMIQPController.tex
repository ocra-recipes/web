...
\item 
void \hyperlink{classMIQPController_a85b7dc746b088c0669d715ee17b02865}{build\-Equality\-Constraints\-Matrices} (\-Eigen\-::\-Matrix\-Xd \&\-Aeq, \-Eigen\-::\-Vector\-Xd \&\-Beq, \-Eigen\-::\-Vector\-Xd \&x\-\_\-k)
\item 
void \hyperlink{classMIQPController_a35df037b7a226f425a2a949b14d860d1}{update\-Equality\-Constraints} (\-Eigen\-::\-Vector\-Xd \&x\-\_\-k)
\end{DoxyCompactItemize}
...
\item 
std\-::shared\-\_\-ptr$<$ \hyperlink{classMIQPState}{\-M\-I\-Q\-P\-State} $>$ \hyperlink{classMIQPController_adc70be859da53c202bc0e0c84cc71917}{\-\_\-state}
\item 
...
\hline
\end{DoxyParams}
\hypertarget{classMIQPController_a85b7dc746b088c0669d715ee17b02865}{\index{\-M\-I\-Q\-P\-Controller@{\-M\-I\-Q\-P\-Controller}!build\-Equality\-Constraints\-Matrices@{build\-Equality\-Constraints\-Matrices}}
...
\item[{\-Eigen\-::\-Vector\-Xd \&}]{x\-\_\-k}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}protected\mbox{]}}}}\label{classMIQPController_a85b7dc746b088c0669d715ee17b02865}
\-Builds the equality constraints matrices \hyperlink{classMIQPController_abc22f1db5a2dbcab4006c1b903a19c4e}{\-\_\-\-Aeq}, \#\-\_\-\-R\-H\-Seq


\begin{DoxyParams}{\-Parameters}
{\em \-Aeq} & \-Reference to output matrix. \\
\hline
{\em \-Beq} & \-Reference to right hand side vector. \\
\hline
{\em x\-\_\-k} & \-Current state vector. \\
\hline
\end{DoxyParams}
...
\item[\hyperlink{todo__todo000007}{\-Todo}]\hyperlink{classMIQPController_a8320465a1ec80d0cf7ba0d17652feba5}{update\-State\-Vector()} needs to be implemented. 
...
\-Deallocates in memory. \-In particular, that of the \-Gurobi environment. \hypertarget{classMIQPController_a35df037b7a226f425a2a949b14d860d1}{\index{\-M\-I\-Q\-P\-Controller@{\-M\-I\-Q\-P\-Controller}!update\-Equality\-Constraints@{update\-Equality\-Constraints}}
...
\item[{\-Eigen\-::\-Vector\-Xd \&}]{x\-\_\-k}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}protected\mbox{]}}}}\label{classMIQPController_a35df037b7a226f425a2a949b14d860d1}
\-Updates the \-R\-H\-S of the equality constraints.

\begin{DoxySeeAlso}{\-See also}
\hyperlink{classMIQPController_a85b7dc746b088c0669d715ee17b02865}{build\-Equality\-Constraints\-Matrices()}, \hyperlink{classMIQPController_a59bee510bcc945ad2267a82ec2116d79}{\-\_\-\-Beq} 
\end{DoxySeeAlso}
...
\begin{DoxyRefDesc}{\-Todo}
\item[\hyperlink{todo__todo000008}{\-Todo}]\-Update state vector using \-\_\-robot\-Model 
...
\hypertarget{classMIQPController_abc22f1db5a2dbcab4006c1b903a19c4e}{\index{\-M\-I\-Q\-P\-Controller@{\-M\-I\-Q\-P\-Controller}!\-\_\-\-Aeq@{\-\_\-\-Aeq}}
...
\-Matrix \-A of the equality constraints of the \-M\-I\-Q\-P problem, i.\-e. \[ A_{\text{eq}} x = b_{\text{eq}} \]

\begin{DoxySeeAlso}{\-See also}
\hyperlink{classMIQPController_a85b7dc746b088c0669d715ee17b02865}{build\-Equality\-Constraints\-Matrices()} 
\end{DoxySeeAlso}
...
\-R\-H\-S of the equality constraints of the \-M\-I\-Q\-P problem, i.\-e. \[ A_{\text{eq}} x = b_{\test{eq}} \]
...
\-Gurobi environment. \-Necessary before setting up the gurobi model \hypertarget{classMIQPController_a338af9b8197f5b08f4e05f2e31342037}{\index{\-M\-I\-Q\-P\-Controller@{\-M\-I\-Q\-P\-Controller}!\-\_\-fcbar\-\_\-eq@{\-\_\-fcbar\-\_\-eq}}
...
\-Positive definite matrix $\mathbf{H}_N$ with the coefficients of the quadratic objective of the \-M\-I\-Q\-P for the walking \-M\-P\-C problem\-: \[ \underset{\mathcal{X}}{\text{min}} \; \mathcal{X}^T \mathbf{H}_N \mathcal{X} + \mathbf{d}^T \mathcal{X} \]
...
\-Contains the state-\/dependent coefficients of the linear term of the objective function of the \-M\-I\-Q\-P for the walking \-M\-P\-C problem.
...
$N_x$ is a diagonal weighting matrix to include the consideration given to the size of the \-Co\-M jerks in $\mathcal{X}$. \-Part of the regularization terms of the quadratic coefficients \hyperlink{classMIQPController_ab4b99d844add54fa7ad6ca6b80cab089}{\-\_\-\-H\-\_\-\-N}. \hypertarget{classMIQPController_a4bac1e68bd433553a7c00677bdc496dd}{\index{\-M\-I\-Q\-P\-Controller@{\-M\-I\-Q\-P\-Controller}!\-\_\-obj@{\-\_\-obj}}
...
\[ \mathbf{R}_{k,N} = \mathbf{R}_B \mathbf{\xi}_k + \mathbf{R}_B \mathcal{X}_{k,N} \] \-Where\-: \[ \mathbf{P}_B = \left[\begin{array}{c} \mathbf{C}_B \mathbf{Q} \\ \vdots\\ \mathbf{C}_B \mathbf{Q}^N \end{array}\right] \]
...
\-Size\-: $[2N\times16]$ \hypertarget{classMIQPController_aed2ce53008e32e64e107398d85e75170}{\index{\-M\-I\-Q\-P\-Controller@{\-M\-I\-Q\-P\-Controller}!\-\_\-period@{\-\_\-period}}
...
\-Size\-: $[2N\times12N]$ \hypertarget{classMIQPController_aa8e6df5286125975521b77501e792413}{\index{\-M\-I\-Q\-P\-Controller@{\-M\-I\-Q\-P\-Controller}!\-\_\-rhs\-\_\-2\-\_\-eq@{\-\_\-rhs\-\_\-2\-\_\-eq}}
...
\-State matrix of the \-R\-H\-S of the \-Simultaneity equality constraint. \hypertarget{classMIQPController_a03735ecec3242cdfc9bf8a443c561724}{\index{\-M\-I\-Q\-P\-Controller@{\-M\-I\-Q\-P\-Controller}!\-\_\-robot\-Model@{\-\_\-robot\-Model}}
...
\hypertarget{classMIQPController_adc70be859da53c202bc0e0c84cc71917}{\index{\-M\-I\-Q\-P\-Controller@{\-M\-I\-Q\-P\-Controller}!\-\_\-state@{\-\_\-state}}
\index{\-\_\-state@{\-\_\-state}!MIQPController@{\-M\-I\-Q\-P\-Controller}}
\subsubsection[{\-\_\-state}]{\setlength{\rightskip}{0pt plus 5cm}std\-::shared\-\_\-ptr$<${\bf \-M\-I\-Q\-P\-State}$>$ {\bf \-M\-I\-Q\-P\-Controller\-::\-\_\-state}\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}\label{classMIQPController_adc70be859da53c202bc0e0c84cc71917}
\-M\-I\-Q\-P \-State \hypertarget{classMIQPController_ada92fc35065a11b889019f2948c1888d}{\index{\-M\-I\-Q\-P\-Controller@{\-M\-I\-Q\-P\-Controller}!\-\_\-\-Sw@{\-\_\-\-Sw}}
...
\-Solution $\mathcal{X}_{k,N}$ of the \-M\-I\-Q\-P problem \hypertarget{classMIQPController_ad1c63725dab2ce84382fcb0b071325ed}{\index{\-M\-I\-Q\-P\-Controller@{\-M\-I\-Q\-P\-Controller}!\-\_\-xi\-\_\-k@{\-\_\-xi\-\_\-k}}
...
\-State vector $\xi_k$ of the \-M\-I\-Q\-P problem\-:
