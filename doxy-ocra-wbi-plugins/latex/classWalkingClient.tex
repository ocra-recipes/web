...
\-Only using the first input computed by the preview controller; \-This input must now be integrated (since it's just the optimal com jerk) \-Should hk be the previously estimated/integrated hkk????

\-Using the zmp cart model, the instantaneous zmp trajectory can now be computed. \-For this we'll pass the current com state hk and the integrated optimal com acceleration.

\-The zmp controller will now use this instantaneous value as reference. \-However, for this reference, a corresponding desired com position and velocity are computed to reduced the zmp tracking error.

\-Apply control \-The \-Z\-M\-P \-Controller is in charge of computing the control\hypertarget{classWalkingClient_ae3c259f7615c85ce53a413f6e7ab4b76}{\index{\-Walking\-Client@{\-Walking\-Client}!perform\-Z\-M\-P\-Test@{perform\-Z\-M\-P\-Test}}
...
\-Performs one of three possible \-Z\-M\-P tests\-:
...
\hline
\end{DoxyParams}
\hypertarget{classWalkingClient_ae6d6c046a9a3e51771afe8b4c105b412}{\index{\-Walking\-Client@{\-Walking\-Client}!publish3d\-Quantity@{publish3d\-Quantity}}
...
\hypertarget{classWalkingClient_afc6a0ac97a4c3f83e27879e803fab8f6}{\index{\-Walking\-Client@{\-Walking\-Client}!\-\_\-zmp\-Controller@{\-\_\-zmp\-Controller}}
\index{\-\_\-zmp\-Controller@{\-\_\-zmp\-Controller}!WalkingClient@{\-Walking\-Client}}
\subsubsection[{\-\_\-zmp\-Controller}]{\setlength{\rightskip}{0pt plus 5cm}std\-::shared\-\_\-ptr$<${\bf \-Zmp\-Controller}$>$ {\bf \-Walking\-Client\-::\-\_\-zmp\-Controller}\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}\label{classWalkingClient_afc6a0ac97a4c3f83e27879e803fab8f6}
...
\hypertarget{classWalkingClient_a20012b4bee7f6de8177ed53907f894cb}{\index{\-Walking\-Client@{\-Walking\-Client}!\-\_\-zmp\-Params@{\-\_\-zmp\-Params}}
\index{\-\_\-zmp\-Params@{\-\_\-zmp\-Params}!WalkingClient@{\-Walking\-Client}}
\subsubsection[{\-\_\-zmp\-Params}]{\setlength{\rightskip}{0pt plus 5cm}std\-::shared\-\_\-ptr$<${\bf \-Zmp\-Controller\-Params}$>$ {\bf \-Walking\-Client\-::\-\_\-zmp\-Params}\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}\label{classWalkingClient_a20012b4bee7f6de8177ed53907f894cb}
