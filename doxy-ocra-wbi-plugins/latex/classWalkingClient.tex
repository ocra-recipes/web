...
\-Only using the first input computed by the preview controller; \-This input must now be integrated (since it's just the optimal com jerk) \mbox{[}\-C\-H\-E\-C\-K\-E\-D\mbox{]}
