...
\-Basically builds matrix $\mathbf{A}$ (\hyperlink{classMIQPLinearConstraints_a7ff7b3584cf9ff3e2124d80bd0684180}{\-\_\-\-A\-Shape\-Admiss}) in the partial expression for the \-M\-I\-Q\-P linear constraints, containing only shape and admissibility constraints, such that\-: \[ \mathbf{A} \mathcal{X}_{k,N} \leq \bar{\mathbf{f}}_c - \mathbf{B} \xi_k \]
